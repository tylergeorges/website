...
export default function Navbar() {
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-30 mx-auto mb-4 flex h-full max-h-14 origin-bottom items-center justify-center">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Link
                    color="secondary"
                    href={social.url}
                    className="hover:bg-accent hover:text-accent-foreground inline-flex size-12 items-center justify-center whitespace-nowrap rounded-full text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
                  >
